...
class HobbyListView(ListView):
    ...
    Отображает все проекты пользователя с количеством постов.
    """
    ...
    def get_queryset(self) -> QuerySet[Hobby]:
        """Возвращает список проектов с количеством постов."""
...
class HobbyDetailView(DetailView):
    ...
    def get_queryset(self) -> QuerySet[Hobby]:
        """Возвращает проекты с предзагруженными постами."""
...
class EntryDetailView(DetailView):
    ...
    def get_queryset(self) -> QuerySet[Entry]:
        """Возвращает пост с предзагруженным проектом и изображениями."""
